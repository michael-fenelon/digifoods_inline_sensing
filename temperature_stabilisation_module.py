...
class Temperature_stabilisation_module():
    ...
    def gen_gui(self):
        ...
        self.pump = Pump(name="Pump 1", window=self.window, bg_color="pale green", canvas_height = 100, canvas_width = 200, x = 200, y= 100)
        self.valve_A = Valve(name="Valve A", window=self.window, canvas_height = 150, canvas_width = 200, x=600, y=300)    
        self.valve_B = Valve(name="Valve B", window=self.window, canvas_height = 150, canvas_width = 200, x=200, y=300)    
        
        # T sensor for recirculation point
        self.t_sensor = T_sensor(name="Recirculation sensor", window=self.window, canvas_height = 100, canvas_width = 120, x=450, y = 350)
        
        self.valve_air_fluid = Valve(name="Valve (Air/Fluid)", canvas_height = 150, canvas_width = 200, window=self.window, x=210, y=600) 
        self.valve_sample_water = Valve(name="Valve (Sample/Water)", canvas_height = 150, canvas_width = 200, window=self.window, x=200, y=600) 
        self.t_sensor = T_sensor(name="Withdrawal sensor", window=self.window, fg_color="firebrick1", canvas_height = 50, canvas_width = 200, x=450, y = 600)
