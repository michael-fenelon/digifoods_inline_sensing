...
class rs485_gui_slave():
    def __init__(self, window = None, slave_number = None, modbus_interface = None, slaves_mcfg = None, 
                    color = "white", canvas_height = 800, canvas_width = 800, logger = None):
        self.window = window
    ...
    def gen_slave_modbus_gui(self):      
        try:    
            ...
            self.logger.info("Read slave " + str(self.slave_number))
        except Exception as e:
            self.logger.info("while reading slave " + str(self.slave_number), e )
    ...
    def update_slave_via_gui(self):
        try:
            ...
            self.logger.warning("In update_slave_via_gui() ", e)
    ...
    def update_slave_via_reg_list(self):
        try:
            ...
            self.logger.warning("In update_slave_via_reg_list() ", e)                  
    ...
    def update_gui(self):
        try:
            ...
            self.logger.warning("In update_gui() ", e)   
