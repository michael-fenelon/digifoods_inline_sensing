...
// SHT35: Grove - I2C High Accuracy Temp&Humi Sensor  https://github.com/Seeed-Studio/Seeed_SHT35
...
void setup()
{
  ...
  if (sht35_sensor.init())
  {
    Serial.println("SHT35 sensor init failed!!");
  }
  else
  {
    Serial.println("Initalised SHT35");
  }
...
void get_temp_hum() {
  ...
  if (array_coils[1] == 1)
  {
    if (NO_ERROR != sht35_sensor.read_meas_data_single_shot(HIGH_REP_WITH_STRCH, &temperature, &humidity))
    {
    ...
    } else
    {
      ...
      Serial.print(humidity);
      array_input_registers[0] = humidity * 10;
      Serial.print("temperature = ");
      Serial.print(temperature);
      array_input_registers[1] = temperature * 10;
      Serial.println(" ℃ ");
